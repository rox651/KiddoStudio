      ...
      <NavLink
         className={({ isActive }) =>
            isActive
               ...
               : `text-[${textColor}] relative group hover:text-[#DF9EF4] font-normal lg:font-semibold transition-colors lg:min-h-5  lg:overflow-y-clip `
         }
         to={redir}
      >
         <span className="text-7xl lg:text-base lg:inline-block lg:group-hover:-translate-y-8 transition-transform">
            {name}
         </span>
